<script>
  ...
  let result = null;
  let analyzing = false;
  let query = "Hot dog or not hot dog?"
  ...
  <main class="flex flex-1 overflow-auto">
    ...
    <div class="w-3/4 p-8 h-full">
      ...
      <div class="bg-white p-8 rounded-lg">
        <h2 class="text-xl font-bold mb-4">Using OpenAI Vision</h2>
        <!-- Quoted Reading in a Rounded Pane -->
        <div class="quote-pane bg-gray-100 p-6 rounded-lg">
          <form on:submit={handleSubmit}>
            <!-- New Query Input Field -->
            <label for="query" class="block font-medium text-gray-700">The Shazam For Food</label>
